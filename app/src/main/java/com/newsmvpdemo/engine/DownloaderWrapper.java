package com.newsmvpdemo.engine;
...
public final class DownloaderWrapper {
    ...
    private static RxBusHelper sRxBus;
    ...
    public static void init(RxBusHelper rxBus, VideoInfoDao videoInfoDao) {
        sRxBus = rxBus;
        sDbDao = videoInfoDao;
    }
